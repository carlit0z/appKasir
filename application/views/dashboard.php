          ...
          <div class="row">
            <div class="col-lg-4 col-sm-6">
              <div class="small-box bg-dark">
                <div class="inner">
                  <h3 class="text-white" id="transaksi_hari">0</h3>
                  <p class="text-white">Transaksi Hari Ini</p>
                </div>
                <div class="icon">
            ...
            <div class="col-lg-4 col-sm-6">
              <div class="small-box bg-dark">
                <div class="inner">
                  <h3 class="text-white" id="transaksi_terakhir">0</h3>
                  <p class="text-white">Produk Transaksi Terakhir</p>
                </div>
                <div class="icon">
            ...
            <div class="col-lg-4 col-sm-6">
              <div class="small-box bg-dark">
                <div class="inner">
                  <h3 class="text-white" id="stok_hari">0</h3>
                  <p class="text-white">Stok Masuk Hari Ini</p>
                </div>
                <div class="icon">
            ...
            <div class="col-md-6">
              <div class="card card-dark">
                <div class="card-header">
                  <h3 class="text-white" class="card-title">Produk Terlaris</h3>
                </div>
                <div class="card-body">
                  <div class="chart">
            ...
            <div class="col-md-6">
              <div class="card card-dark">
                <div class="card-header">
                  <h3 class="text-white" class="card-title">Stok Produk</h3>
                </div>
                <div class="card-body">
            ...
            <div class="col-12">
              <div class="card card-dark">
                <div class="card-header">
                  <h3 class="text-white" class="card-title">Penjualan Bulan Ini</h3>
                </div>
                <div class="card-body">
                  <div class="chart">
